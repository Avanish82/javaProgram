...
//				//	authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(authenticationRequest.getUsername(), bCryptPasswordEncoder(authenticationRequest.getPassword())));
